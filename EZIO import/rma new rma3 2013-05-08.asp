...
<table cellspacing=0 cellpadding=0 border=0>
    <tr valign="top">
        <td style="padding-right: 15px">
            ...
            <input type='radio' name="rmatype" value="D"<%if rmatype = "D" or session("debcode") = "01DMX001" or (session("company") = "EIZO Europe GmbH" AND session("AXCustAccount") = "14312") then%> checked='checked'<%end if%>/>Depot Repair<br />
        </td>
<%if session("debcode") = "01DMX001" then%>
        <td>
			<font face="Verdana" size='2'>
