...
FROM C_SERIALNUMBERS 
	...
	LEFT OUTER JOIN INVENTTABLE ON INVENTTABLE.ITEMID = C_SERIALNUMBERS.ITEMID and INVENTTABLE.DATAAREAID = 'de' 
	...
	LEFT OUTER JOIN INVENTTABLE as SupportItem ON SupportItem.ITEMID = C_CONTRACTITEMS.SUPPORTCOVERAGE AND SupportItem.DATAAREAID = C_CONTRACTITEMS.DATAAREAID 
WHERE C_SERIALNUMBERS.SERNUM like '%18102802863101%' AND ISNULL(C_CONTRACTITEMS.Active, 1) = 1 AND 
   (SALESTABLE.INVOICEACCOUNT = '14312' or C_SERIALNUMBERS.CUSTOMER = '14312' and c_serialnumbers.dataareaid = 'de');
